...
describe('D2 — knobsHash differs across cross-modal knob values', () => {
  ...
  test('KNOBS_HASH_VERSION is 5 (master v=4 schema-pack; v0.40.5.0 D8 CR appends)', () => {
    // v0.35 ladder: 1→2 reranker, 2→3 floor_ratio. v0.36 piggybacks on v=3
    // with 7 cross-modal knobs + column/provider context. v0.39 T21 bumps
    // to v=4 for schema-pack fields. v0.40.5.0 D8 bumps to v=5 (sequenced
    // behind salem's v=4 graph-signals).
